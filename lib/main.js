...
function createPresignedUrl() {
    ...
    return v4.createPresignedURL(
        ...
        crypto.createHash('sha256').update('', 'utf8').digest('hex'), {
            ...
            'key': "AKIAZSI2VN6WE5T5VB3N",
            'secret': "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",
            'sessionToken': "",
            'protocol': 'wss',
            'expires': 15,
            'region': "eu-west-1",
            'query': "language-code=" + languageCode + "&media-encoding=pcm&sample-rate=" + sampleRate //+ "&show-speaker-label=" + speaker
            // 'key': $('#access_id').val(),
